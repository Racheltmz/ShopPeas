...
const RegisterWholesaler = () => {
    ...
    return (
        <View style={styles.container}>
            <Text>Wholesaler Registration</Text>
            ...
            <TextInput style={styles.input} placeholder="UEN" autoCapitalize="none" onChangeText={(text) => setUen(text)}></TextInput>
            <TextInput style={styles.input} placeholder="Phone Number" autoCapitalize="none" onChangeText={(text) => setNumber(text)}></TextInput>
            <TextInput style={styles.input} placeholder="Address" autoCapitalize="none" onChangeText={(text) => setAddress(text)}></TextInput>
